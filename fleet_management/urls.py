...
from .Templates.maintenance_management.views import alerts_for_servicing_needs, maintenance_history_logging, preventive_maintenance_scheduling
from .Templates.driver_management.views import driver_assignment, license_and_certification_tracking, driver_performance_monitoring
from .Templates.safety_and_compliance.views import accident_reporting, regulatory_compliance_tracking, vehicle_inspections

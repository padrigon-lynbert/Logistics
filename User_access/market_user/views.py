...
def index_market_user(request):
    return render(request, 'index_user.html')

def explore_user(request):
    return render(request, 'explore_user.html')

def item_details_user(request):
    return render(request, 'details_user.html')

def author_user(request):
    return render(request, 'author_user.html')
...
def signup_user(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('index_market_user')  # Redirect to a login page (you can adjust this)
    else:
        form = SignupForm()
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if result:
                ...
                return render(request, 'signin_user.html', {'error': 'Invalid pass'})

        except UserInfo.DoesNotExist:
            return render(request, 'signin_user.html', {'error': 'User not found'})
...
def vendor_signup_user(request):
    if request.method == 'POST':
    ...
    return render(request, 'vendor_signup_user.html')

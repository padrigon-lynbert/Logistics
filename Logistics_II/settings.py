"""
Django settings for Logistics_II project.
...
# SECRET_KEY = 'django-insecure-k@v*ibkmr3+h@5p7qw1#&splh^n$we(s=w*+dmfj+-@#$s*px2'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',
            BASE_DIR / 'vendor_portal/templates',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Logistics_II.wsgi.application'

...
from .views import policies, procedures, audits, edit_audit, delete_audit
...
urlpatterns = [
    ...
    path('audit/compliance_management/delete_audit/<int:audit_id>/', delete_audit, name='delete_audit'),
